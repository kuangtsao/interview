...
def uat(bot,jenkins_robot,version,chat_id):
    bot.send_message(chat_id,"開始更新 B 組 UAT LOBBY")
    update_lobby = 'https://jenkins.fromer.url/job/B_LOBBY_UPDATE/buildWithParameters'
